...
#main 
{
 ...
 background-image:url('../images/mangament.png');
 background-size:cover;
 background-position:center;
}
#main1
...
<!--main div start-->
  <div id="main">
  <h1 style="text-align:center;color:darkred;">User Management</h1>
  <hr>
  <table style="margin:0px auto;width:95%;margin-top:10px;color:#fff;" border="1">
  <tr>
  <th>SNo.</th>
  <th>Name</th>
  <th>Gender</th>
